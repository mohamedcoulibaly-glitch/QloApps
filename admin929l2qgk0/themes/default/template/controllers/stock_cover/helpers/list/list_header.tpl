	...
	<div class="filter-stock-extended">
		<form id="stock_cover" method="get" class="form-horizontal">
			...
			<div class="form-group">
				<label for="coverage_period" class="control-label col-lg-3">{l s='Filtrer par période :'}</label>
				<div class="col-lg-9">
			...
			{/if}
			<div class="form-group">
				<label for="warn_days" class="control-label col-lg-3">{l s='Surligner lorsque la couverture (en jours) est inférieure à :'}</label>
				<div class="col-lg-9">
