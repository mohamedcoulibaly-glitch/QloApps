<tr id="product_rule_{$product_rule_group_id|intval}_{$product_rule_id|intval}_tr">
	<td>
		...
		[{if $product_rule_type == 'products'}{l s='Types de chambres :'}{elseif $product_rule_type == 'categories'}{l s='Catégories :'}{elseif $product_rule_type == 'manufacturers'}{l s='Fabricants :'}{elseif $product_rule_type == 'suppliers'}{l s='Fournisseurs'}{elseif $product_rule_type == 'attributes'}{l s='Attributs'}{/if}]
	</td>
	<td>
