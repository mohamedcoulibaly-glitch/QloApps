<div class="form-group hidden">
	<label class="control-label  col-lg-3">{l s='Livraison gratuite'}</label>
	<div class="col-lg-9">
...
<div class="form-group">
	<label class="control-label col-lg-3">{l s='Appliquer une réduction'}</label>
	<div class="col-lg-9">
		<div class="radio">
		...
		<div class="radio">
			<label for="apply_discount_off">
				...
				<i class="icon-remove color_danger"></i> {l s='Aucun'}
			</label>
		</div>
	</div>
</div>
...
<div id="apply_discount_percent_div" class="form-group">
	<label class="control-label col-lg-3">{l s='Valeur'}</label>
	<div class="col-lg-9">
...
<div id="apply_discount_amount_div" class="form-group">
	<label class="control-label col-lg-3">{l s='Montant'}</label>
	<div class="col-lg-7">
		<div class="row">
			<div class="col-lg-4">
			...
			<div class="col-lg-4">
				<select name="reduction_tax" >
					<option value="0" {if $currentTab->getFieldValue($currentObject, 'reduction_tax') == 0}selected="selected"{/if}>{l s='HT'}</option>
					<option value="1" {if $currentTab->getFieldValue($currentObject, 'reduction_tax') == 1}selected="selected"{/if}>{l s='TTC'}</option>
				</select>
			</div>
		</div>
	</div>
...
<div id="apply_discount_to_div" class="form-group">
	<label class="control-label col-lg-3">{l s='Appliquer une réduction à'}</label>
	<div class="col-lg-7">
		<p class="radio">
		...
		<p class="radio">
			<label for="apply_discount_to_product">
				...
				{l s='Type de chambre spécifique'}
			</label>
		</p>
		<p class="radio">
			<label for="apply_discount_to_cheapest">
				<input type="radio" name="apply_discount_to" id="apply_discount_to_cheapest" value="cheapest"{if $currentTab->getFieldValue($currentObject, 'reduction_product')|intval == -1} checked="checked"{/if} />
				 {l s='Type de chambre le moins cher'}
			</label>
		</p>
		<p class="radio">
			<label for="apply_discount_to_selection">
				...
				{l s='Type(s) de chambre sélectionné(s)'}{if $product_rule_groups|@count == 0}&nbsp;<span id="apply_discount_to_selection_warning" class="text-muted clearfix"><i class="icon-warning-sign"></i> <a href="#" id="apply_discount_to_selection_shortcut">{l s='Vous devez d&#039;abord sélectionner des types de chambres'}</a></span>{/if}
			</label>
		</p>
	</div>
</div>
...
<div id="apply_discount_to_product_div" class="form-group">
	<label class="control-label col-lg-3">{l s='Type de chambre'}</label>
	<div class="col-lg-9">
...
<div class="form-group hidden">
	<label class="control-label col-lg-3">{l s='Envoyer un cadeau gratuit'}</label>
	<div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
...
<div id="free_gift_div" class="form-group">
	<label class="control-label col-lg-3">{l s='Rechercher un produit'}</label>
	<div class="col-lg-9">
		<div class="input-group col-lg-5">
...
<div id="gift_products_found" {if $gift_product_select == ''}style="display:none"{/if}>
	<div id="gift_product_list" class="form-group">
		<label class="control-label col-lg-3">{l s='Produits correspondants'}</label>
		<div class="col-lg-5">
	...
	<div id="gift_attributes_list" class="form-group" {if !$hasAttribute}style="display:none"{/if}>
		<label class="control-label col-lg-3">{l s='Combinaisons disponibles'}</label>
