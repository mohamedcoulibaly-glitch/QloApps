...
<div class="panel-footer">
	...
	{/if}
	<a href="" class="btn btn-default pull-right" onclick="if (confirm('{l s='Mettre à jour les éléments sélectionnés ?'}'))sendBulkAction($(this).closest('form').get(0), 'submitBulkUpdatesupply_order_detail'); return false;">
		<i class="process-icon-refresh" ></i> <span>{l s='Mettre à jour les éléments sélectionnés'}</span>
	</a>
</div>
{/block}
