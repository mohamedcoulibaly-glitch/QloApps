...
{block name="td_content"}
	{if $key == 'url'}
		...
		{else}
			<a href="{$link->getAdminLink('AdminShopUrl')|escape:'html':'UTF-8'}&amp;shop_id={$tr.$identifier|intval}&amp;addshop_url" class="multishop_warning">{l s='Cliquez ici pour définir une URL pour cette boutique.'}</a>
		{/if}
	{else}
		{$smarty.block.parent}
	{/if}
